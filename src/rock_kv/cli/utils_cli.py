...
def update_parser(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--channel_selection",  type=int, default=-1,       choices=[-1, 0, 1, 2, 3], help="Channel selection method: 0 for Random, 1 for Variance, 2 for Magnitude, 3 for RoPE-aware")
    return parser